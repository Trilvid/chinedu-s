...
const Login = ({route}) => {
  ...
  <img src="/whitelogo (2).png" alt="" onClick={()=>{ navigate('/')  }}/>
  </div>
  <div className="title_container">
    <p className="title">Login to your Account</p>
    <span className="subtitle">Continue with our app, just login to your account and enjoy the experience.</span>
  </div>
  <br />
  <div className="input_container">
    ...
    {/* try to remeber that the email type might be problematic change to type text if there is a problem */}
    <input 
  ...
  <div className="input_container">
    ...
    />
    <span onClick={()=>{setShowPassword(!showPassword)}} className='passIcon'>
                        {
                          showPassword ?
                          <BsEye />
                           :
...
<div className="input_container remeberMex">
  <input 
  type="checkbox" 
  name="text" 
  id="remeberme" 
...
<p class="note" onClick={()=>{ navigate('/signUp') }}> Sign up</p>
